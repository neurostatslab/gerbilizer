...
def build_config(config_name, job_id):
	...
	if config_name == "default":
		...
		CONFIG = {
			...
			'CONV_BLOCK_1_OUT_CHANNELS': 64,
			'CONV_BLOCK_1_KERNEL_SIZE': 3,
			'CONV_BLOCK_1_MAXPOOL_SIZE': 8,

			'CONV_BLOCK_2_IN_CHANNELS': 64,
			'CONV_BLOCK_2_OUT_CHANNELS': 64,
			'CONV_BLOCK_2_KERNEL_SIZE': 3,
			'CONV_BLOCK_2_MAXPOOL_SIZE': 8,

			'CONV_BLOCK_3_IN_CHANNELS': 64,
			'CONV_BLOCK_3_OUT_CHANNELS': 64,
			'CONV_BLOCK_3_KERNEL_SIZE': 3,
			'CONV_BLOCK_3_MAXPOOL_SIZE': 2,
